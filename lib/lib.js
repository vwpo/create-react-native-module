...
` + (generateExample
  ...
  exampleWithFileLink: ${exampleWithFileLink}
      ...
      return Promise.resolve()
        ...
        .then(() => {
          ...
          return new Promise((resolve, reject) => {
            ...
            // the DEPRECATED --example-with-file-link option
            // (exampleWithFileLink) is used
            // (not needed otherwise):
            if (exampleWithFileLink) {
            ...
            const yarnLinkCommand = exampleWithFileLink
              ? 'yarn add file:../'
              : 'yarn add link:../';
