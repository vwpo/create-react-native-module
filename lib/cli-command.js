...
${postCreateInstructions(createOptions)}`);
  ...
  options: [{
    ...
    command: '--example-symlink-disabled',
    description: "DEPRECATED: do `yarn add file:../'` instead of `yarn add link:../` in a generated example project, and add a postinstall script",
  }, {
